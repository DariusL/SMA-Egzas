% Niutono-Koteso formules: tyrimas

function niutonoKotesoIntegralas
    ...
    format long
    Integralas=Newton_Cotes(F,a,b,N)

    figure(1),hold on, grid on, plot(xxx,eval(subs(f,x,sym(xxx))), 'Linewidth',2);
